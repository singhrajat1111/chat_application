  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-surface-900 rounded-2xl shadow-xl shadow-surface-900/5 dark:shadow-primary-900/10 border border-surface-200/60 dark:border-surface-700/50 p-8 space-y-5">
