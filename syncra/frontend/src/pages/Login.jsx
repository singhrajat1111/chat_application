  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-surface-900 dark:text-white">Welcome to Syncra</h1>
        <p className="mt-2 text-surface-500 dark:text-surface-400">Sign in to continue messaging</p>
      </div>
      ...
      <div className="w-full max-w-md">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-surface-900 rounded-2xl shadow-xl shadow-surface-900/5 dark:shadow-primary-900/10 border border-transparent dark:border-surface-700/50 p-8 space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 btn-gradient text-white font-medium rounded-lg transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            {isLoading ? (
